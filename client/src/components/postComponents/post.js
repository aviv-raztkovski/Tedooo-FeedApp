        ...
        <div className="post">
            <div className="userInfo">
                ...
                <div className="userInfo-text">
                    ...
                    <p className="shopName">{shopName} <span className="date">{getTimeDifference()}</span></p>
                </div>
            </div>
            ...
            <div className="post-btns">
                <button className={`btn btn-post btn-post-like ${didLike === 'true' ? "btn-post-active": ""}`}>
                    <span>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 toolbar-svg">
                ...
                <button className="btn btn-post btn-post-comment">
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 toolbar-svg">
